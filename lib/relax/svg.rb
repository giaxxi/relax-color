...
require_relative './svg/shape/ellipse.rb'
require_relative './svg/shape/line.rb'
require_relative './svg/shape/polyline.rb'
require_relative './svg/shape/polygon.rb'
require_relative './svg/shape/path.rb'
require_relative './svg/shape/path_data.rb'
